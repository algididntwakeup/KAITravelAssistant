    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
            <svg viewBox="0 0 400 300" className="w-full h-64 border rounded">
                ...
                <text x="200" y="104" textAnchor="middle" className="text-sm fill-white font-semibold">PERON 7</text>
                <rect x="60" y="140" width="280" height="40" fill="#1e40af" rx="4"/>
                <text x="200" y="164" textAnchor="middle" className="text-sm fill-white font-semibold">PERON 6</text>
                <rect x="60" y="200" width="280" height="40" fill="#1e40af" rx="4"/>
                <text x="200" y="224" textAnchor="middle" className="text-sm fill-white font-semibold">PERON 5</text>
