// src/components/KaiLogo.jsx
import React from 'react';

// Komponen ini berfungsi sebagai "pembungkus" untuk SVG logo KAI Anda.
// Ia menerima 'className' sebagai prop, sehingga kita bisa mengatur ukurannya dari luar.
export const KaiLogo = ({ className }) => (
  <svg
    className={className}
    // 1. ViewBox sudah disesuaikan dengan SVG asli Anda
    viewBox="0 0 294.74 124.22"
    xmlns="http://www.w3.org/2000/svg"
  >
    {/* 2. Kode SVG Anda sudah dikonversi ke format JSX yang benar */}
    <g>
      <g>
        {/* Warna dari class .cls-1 diterapkan langsung sebagai atribut fill */}
        ...
        {/* Warna dari class .cls-2 diterapkan langsung sebagai atribut fill */}
